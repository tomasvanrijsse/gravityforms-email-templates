...
class BasicTemplate extends GFEmailTemplate
{
     ...
     * Email HTML based upon https://github.com/leemunroe/responsive-html-email-template
     * @param $notification
     * @param $form
     * @param $entry
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                <tr>
                  <td class="content-block" style="font-family:sans-serif;font-size:14px;vertical-align:top;color:#999999;font-size:12px;text-align:center;">
                    <a href="$siteUrl" class="apple-link" style="color:#999999;font-size:12px;text-align:center;">Send from $siteUrl</a>
                  </td>
                </tr>
              </table>
            </div>
